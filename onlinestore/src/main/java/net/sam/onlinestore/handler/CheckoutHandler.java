package net.sam.onlinestore.handler;
...
import net.sam.onlinestore.model.CheckoutModel;
import net.sam.onlinestore.model.UserModel;
import net.sam.storebackend.dao.CartLineDAO;
import net.sam.storebackend.dao.ProductDAO;
import net.sam.storebackend.dao.UserDAO;
...
import net.sam.storebackend.dto.OrderItem;
import net.sam.storebackend.dto.Product;
